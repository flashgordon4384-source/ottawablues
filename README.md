...
## Files
- `Ottawa Blues Charity Classic.dc.html` — the complete design prototype. Opens directly in a
  browser. Markup and inline styles carry every value documented above; the data arrays and the
  countdown / accordion / registration-state logic live in the `<script>` logic class at the
  bottom of the file. Read it alongside this README.
